...
export default function IntegrationSlack({ done }: { done: any }) {
  ...
  const fields = [
    ...
    { id: 2, name: 'tokenID', label: "Token ID", errorMessage: "Please fill the Token ID!" },
    { id: 3, name: 'channelID', label: "Channel ID", errorMessage: "Please fill the Channel ID!" },
  ];
